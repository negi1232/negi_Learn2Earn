        ...
        try {
            if (ethereum) {
                ...
                if (approval.toString() >= parseUnits((reward* correct_limit).toString(), 18).toString()) {
                    ...
                    const res = await Quiz_Contract.create_quiz(title.toString(), explanation.toString(), thumbnail_url.toString(), content.toString(), answer_type.toString(), answer_data.toString(), correct.toString(), epochSeconds.toString(), (reward*10**18).toString(), correct_limit.toString());
